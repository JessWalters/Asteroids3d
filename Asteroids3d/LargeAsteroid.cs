...
namespace Asteroids3d
{
    internal class LargeAsteroid : DrawableGameComponent
    {
        ...
        public LargeAsteroid(Game game) : base(game)
        {
            game.Components.Add(this);
        }

        public LargeAsteroid(Game game, Vector3 pos) : this(game)
        {
        ...
        public LargeAsteroid(Game game, Vector3 pos, float mass) : this(game, pos)
        {
            physicsObject.Mass = mass;
        }

        public LargeAsteroid(Game game, Vector3 pos, float mass, Vector3 linMomentum) : this(game, pos, mass)
        {
            physicsObject.LinearMomentum = ConversionHelper.MathConverter.Convert(linMomentum);
        }

        public LargeAsteroid(Game game, Vector3 pos, float mass, Vector3 linMomentum, Vector3 angMomentum) : this(game, pos, mass, linMomentum)
        {
